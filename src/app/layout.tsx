...
export const metadata: Metadata = {
  ...
  authors: [
    {
      name: "Kajal Tiwari",
      url: "https://github.com/Kajal-Tiwari-22",
    },
  ],
  creator: "Kajal Tiwari",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://github.com/Kajal-Tiwari-22",
    ...
    siteName: "Kajal Tiwari Portfolio",
  },
  twitter: {
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href="/logo-kajal.svg" sizes="any" />
        {/* Google Analytics */}
        <Script
          async
