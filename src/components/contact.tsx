  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'kajaltiwari23jan@gmail.com',
      href: 'mailto:kajaltiwari23jan@gmail.com',
      color: 'text-blue-600'
    },
    {
    ...
    },
    {
      ...
      title: 'LinkedIn',
      value: 'kajal-tiwari23jan',
      href: 'https://linkedin.com/in/kajal-tiwari23jan',
      color: 'text-blue-700'
    },
    {
      icon: <Github className="h-5 w-5" />,
      title: 'GitHub',
      value: 'Kajal-Tiwari-22',
      href: 'https://github.com/Kajal-Tiwari-22',
      color: 'text-gray-800'
    }
  ];
